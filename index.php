 ...
 * Εδώ είναι η κεντρική βιτρίνα της εφαρμογής MedBook.
 */
...
<section class="hero">
  <div class="hero-content">
    ...
    <p>Εύκολα, γρήγορα και με ασφάλεια. Συμπληρώστε τη φόρμα και θα επικοινωνήσουμε μαζί σας για τυχόν διευκρίνιση.</p>
...
<section style="padding: 3rem 1rem 1rem; max-width: 800px; margin: 0 auto; text-align: center;">
  ...
  <p style="color: var(--text-muted); line-height: 1.7; font-size: 1.05rem;">
    Το <strong>MedBook</strong> είναι η νέα ψηφιακή πλατφόρμα του ιατρείου μας, σχεδιασμένη για την απόλυτη δική σας διευκόλυνση. 
    Εδώ μπορείτε να δείτε άμεσα τις διαθέσιμες ώρες και να δεσμεύσετε το ραντεβού σας με ελάχιστα κλικ. 
    Δεν χρειάζεται να δημιουργήσετε λογαριασμό ή να θυμάστε κωδικούς. Επιλέξτε παρακάτω την ενέργεια που επιθυμείτε!
  </p>
</section>
